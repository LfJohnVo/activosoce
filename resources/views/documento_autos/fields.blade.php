...
<div class="form-group col-sm-6">
    ...
    <select class="form-control" id="idAuto" name="idAuto" required>
        ...
        <option value="{{ $auto->id }}" {{ $auto->id == $documentoAuto->idAuto ? 'selected' : '' }}>{{ $auto->placas }}</option>
        @endforeach
    </select>
</div>
...
<div class="form-group col-sm-12 col-lg-12">
    ...
    <input type="file"  accept="application/pdf,application" class="form-control-file" id="responsivaEmpleado" name="responsivaEmpleado">
</div>

<!-- Ultimatenencia Field -->
<div class="form-group col-sm-12 col-lg-12">
    {!! Form::label('ultimaTenencia', 'Ultima tenencia:') !!}
    <input type="file"  accept="application/pdf,application" class="form-control-file" id="ultimaTenencia" name="ultimaTenencia">
</div>

<!-- Ultimaverificacion Field -->
<div class="form-group col-sm-12 col-lg-12">
    {!! Form::label('ultimaVerificacion', 'Ultima verificación:') !!}
    <input type="file"  accept="application/pdf,application" class="form-control-file" id="ultimaVerificacion" name="ultimaVerificacion">
</div>
